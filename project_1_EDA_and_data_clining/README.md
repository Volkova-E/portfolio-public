...
- Большинство опрошенных ДХ не имеют источника дохода, ..% получают зарплату от наемной работы и только % получают доход только от бизнеса, еще % совмещают бизнес и найм. В зависимости от типа занятости наблюдаются различия в доходе, при этом для города они несколько выше. Наибольших доход среди городских ДХ наблюдается у тех, кто совмещает бизнес и найм, а среди сельских - у наемных рабочих.
